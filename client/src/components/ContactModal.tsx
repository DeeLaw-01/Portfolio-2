...
export default function ContactModal ({ isOpen, onClose }: ContactModalProps) {
  ...
  useEffect(() => {
    ...
    const handleKeyDown = (e: KeyboardEvent) => {
      ...
      // Enter to submit (only if not in textarea and form is valid)
      if (e.key === 'Enter' && e.target instanceof HTMLElement) {
        if (e.target.tagName !== 'TEXTAREA' && !isSubmitting) {
  ...
  }, [isOpen, formData, isSubmitting, onClose])
      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className='relative bg-[#0e0e14] border border-[#7203a9]/20 rounded-[20px] p-4 sm:p-6 lg:p-8 w-full max-w-4xl max-h-[90vh] overflow-y-auto shadow-2xl'
          >
            {/* Close Button */}
            <motion.button
            ...
            >
              ...
              <div className='flex flex-col justify-center lg:pr-4'>
                ...
                <p className='text-[#dadada]/70 text-sm sm:text-base leading-relaxed mb-4 sm:mb-6'>
                  ...
                  want to collaborate, or just want to say hello, I'm always
