                  ...
                  <div key={`${lineIndex}-${stepIndex}`}>
                    ...
                    >
                      ...
                      >
                        ...
                        <p
                          className={cn(
                            'absolute bottom-0 left-1/2 line-clamp-3 flex w-[180px] -translate-x-1/2 translate-y-[calc(100%_+_28px)] items-center justify-center text-center text-xs transition-opacity duration-300 ease-in',
                      ...
                      {stepIndex === 0 && (
                        <div
                          className={cn(
                            'absolute top-0 left-1/2 z-10 -translate-x-1/2 translate-y-[calc(-100%-16px)] whitespace-nowrap text-sm font-medium',
                            isActive
